...
fn test_parse_price() -> Result<()> {
    assert_eq!(
        ...
        vec![Node::DatedPrice(DatedPrice {
...
"
        ...
        vec![
            ...
            Node::Transaction(Transaction {
                date: NaiveDate::from_ymd_opt(2023, 4, 9).unwrap().into(),
...
"
        ...
        vec![
            ...
            Node::EmptyLine,
            Node::Transaction(Transaction {
                date: NaiveDate::from_ymd_opt(2023, 4, 10).unwrap().into(),
...
#[test]
fn test_parse_transaction_with_priced_and_dated_commodity_and_lot_price() -> Result<()> {
    assert_eq!(
        parse_str(
            r"
2023/04/09 opening
